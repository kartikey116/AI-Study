...
mixin _$UserModel {
  ...
  bool operator ==(Object other) {
    ...
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.profile, _this.profile) ||
                other.profile == _this.profile));
  }
  ...
  int get hashCode {
    final _this = this as UserModel;
    return Object.hash(runtimeType, _this.id, _this.email, _this.profile);
  }

  @override
  String toString() {
    final _this = this as UserModel;
    return 'UserModel(id: ${_this.id}, email: ${_this.email}, profile: ${_this.profile})';
  }
}
...
abstract mixin class $UserModelCopyWith<$Res> {
  ...
  @useResult
  $Res call({String id, String email, ProfileModel? profile});
...
extension UserModelPatterns on UserModel {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(String id, String email, ProfileModel? profile)?
        $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
      case _UserModel() when $default != null:
        return $default(_that.id, _that.email, _that.profile);
      case _:
        return orElse();
    }
  }
  ...
  TResult when<TResult extends Object?>(
    TResult Function(String id, String email, ProfileModel? profile) $default,
  ) {
    final _that = this;
    switch (_that) {
      case _UserModel():
...
class _UserModel implements UserModel {
  const _UserModel({required this.id, required this.email, this.profile});
  ...
  @override
  int get hashCode {
    return Object.hash(runtimeType, id, email, profile);
  }
...
mixin _$ProfileModel {
  ...
  int get hashCode {
    final _this = this as ProfileModel;
    return Object.hash(
        runtimeType, _this.firstName, _this.lastName, _this.avatarUrl);
  }

  @override
  String toString() {
    final _this = this as ProfileModel;
    return 'ProfileModel(firstName: ${_this.firstName}, lastName: ${_this.lastName}, avatarUrl: ${_this.avatarUrl})';
  }
}
...
extension ProfileModelPatterns on ProfileModel {
  ...
  TResult maybeWhen<TResult extends Object?>(
    ...
    switch (_that) {
      case _ProfileModel() when $default != null:
        return $default(_that.firstName, _that.lastName, _that.avatarUrl);
      case _:
        return orElse();
    }
  }
...
class _ProfileModel implements ProfileModel {
  const _ProfileModel({this.firstName, this.lastName, this.avatarUrl});
  ...
  @override
  int get hashCode {
    return Object.hash(runtimeType, firstName, lastName, avatarUrl);
  }

  @override
  String toString() {
    return 'ProfileModel(firstName: $firstName, lastName: $lastName, avatarUrl: $avatarUrl)';
  }
}
